...
echo %TargetDir%
%ilmerge% /out:"%outdir%\o2pgen.exe" "%TargetDir%\%TargetName%.exe" "%TargetDir%\*.dll" /target:exe /targetplatform:v4,C:\Windows\Microsoft.NET\Framework\v4.0.30319 /wildcards /ndebug 
